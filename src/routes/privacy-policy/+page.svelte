	...
	<div class="outer-container">
		<div class={itemsContainerClass}>
			<div class={chunkClass}>
				...
				<p class="body-text">Any data saved is stored locally on your device and in your device's cloud storage (if enabled), and is done so only to remember your preferences and progress.</p>
				<p class="body-text">This data is never communicated to any other location by any of these apps.</p>
				<p class="body-text">Enjoy!</p>
			</div>
		</div>
	</div>
</div>
